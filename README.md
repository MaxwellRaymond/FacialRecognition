...
A Python based facial recognition program that can encode, validate, and recognize faces using the face_recognition and Pillow libaries. Supporting both hog and cnn models and provides a clean command-line interaface for training and testing the model.
...
- Walkthrough
    ...
    - **NOTE:** This walkthrough was used as a guide for help, not followed blindly. This projects goal was to expand my knowledge on machine learning in Python and get my hands dirty working with libraries I was not familiar with.
